...
type MyBookingItem struct {
	ID          string
	DateDisplay string // e.g. "02/14 (六) 14:30"
	Title       string // e.g. "師大班 @ 師大附中"
	Attendees   []*Attendee
}
...
type DayData struct {
	DateDisplay string // e.g. "13"
	DayOfWeek   string // e.g. "Fri"
	FullDate    string // e.g. "2026-02-13"
	IsToday     bool
	Slots       []*SlotData
}
...
type SlotData struct {
	ID          string
	TimeDisplay string // e.g. "16:30"
	CourseName  string // e.g. "足球"
	Location    string
	Capacity    int
	BookedCount int
	Attendees   []*Attendee
	IsFull      bool
	IsEmpty     bool // If true, this is an empty slot (no course)
}

// Attendee represents a child in a slot.
type Attendee struct {
	Name        string
	Status      string // "Booked", "Leave", "CheckedIn", "Absent"
